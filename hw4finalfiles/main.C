...
// Note : there is a problem with the course's test files because they
// were written in Windows instead of unix. Therefore, you should run
// them through dos2unix first, and then compare. The files will be
// identitcal then.
...
//  Description   : Print message of failure with given
//					command tokens.
//  Paramaters    : tokens - vector of parameters strings
//  Return value  : None.
//**********************************************************
...
// All functions below are interpretations of the commands from
// the main function. Every one of funcs gets the office and
// the required tokens from main and executes the command.
